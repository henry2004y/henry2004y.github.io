...
VSCode has very nice support for C++. A nice tutorial to follow can be found [here](https://medium.com/@li.nguyen_15905/setting-up-vscode-for-mpi-programming-b6665da6b4ad). Generally speaking, you only need to add the relevant extensions and set up the paths in the config files (`.vscode/*.json`).
