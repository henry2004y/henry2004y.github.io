...
{% include figure image_path="tfd_doppler_compare.png" alt="tfd_doppler" caption="Comparison between different time-frequency transforms with an analytical signal of Doppler shift." %}
